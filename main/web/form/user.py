...
from xflask.wtforms.validator import DataRequired, Length, Email, Optional, EnumValidator
...
class UserForm(Form):
    ...
    edu_level   = EnumField(EducationLevel, validators=[DataRequired(), EnumValidator(EducationLevel)])
